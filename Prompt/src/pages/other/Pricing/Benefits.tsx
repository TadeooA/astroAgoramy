// types
import { Benefit } from '../Career/types.ts'
						...
						return (
							<div key={idx}>
								<div className="flex items-center lg:justify-center gap-6">
									...
									<div>
										<h5 className="text-base">{benifit.title}</h5>
										<p className="text-slate-400 mt-2">{benifit.description}</p>
									</div>
								</div>
							</div>
						)
